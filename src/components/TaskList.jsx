            ...
            <div className="task-container">
                ...
                <div className="task-scroll-container">
                    {filteredList.map((elem, idx) => (
                        ...
                        >
                            <div data-label="Task No.">#{idx + 1}</div>
                            <div data-label="Title" className="task-title-cell">{elem.taskTitle}</div>
                            {elem._id === editTask ? (
                                <>
                                    ...
                                    <div data-label="Assignor">{elem.assignor}</div>
                                    ...
                                    <div data-label="Actions" className="task-actions">
                                ...
                                <>
                                    <div data-label="Assignee">{elem.assignee}</div>
                                    <div data-label="Assignor">{elem.assignor}</div>
                                    <div data-label="Deadline" className="deadline-cell">
